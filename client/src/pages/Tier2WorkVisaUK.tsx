          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              <div className="order-1 md:order-2">
                <img src={`${import.meta.env.BASE_URL}services/businessvisa.jpg`} alt="Tier 2 Work Visa UK" className="w-full h-56 md:h-full rounded-xl object-cover shadow-lg" />
              </div>
            </div>
          </div>
        </div>
