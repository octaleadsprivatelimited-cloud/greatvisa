...
import { Globe, CheckCircle, Building, Clock, Shield, ArrowRight } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              Get a free consultation with our business visa experts and start your international expansion journey.
            </p>
