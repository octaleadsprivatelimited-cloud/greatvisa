...
import { Code, CheckCircle, Clock, Users, Mail, Phone, MapPin, ArrowRight, MessageCircle, Laptop, Zap } from 'lucide-react';
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 text-center">
                Start Your Ireland Tech Journey
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-transparent transition"
                    placeholder="Tell us about your tech skills and experience..."
                  ></textarea>
                </div>
