...
import { Code, CheckCircle, Users, Mail, Phone, ArrowRight, MessageCircle, Laptop, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          >
            Best Ireland IT Professional Work Visa Consultancy
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Launch Your Tech Career in Ireland's Silicon Docks
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                { icon: Code, title: "Tech Skills Assessment", desc: "Evaluate your tech profile for Irish market" },
                { icon: Laptop, title: "Job Placement Support", desc: "Connect with top Irish tech companies" },
                { icon: Zap, title: "Fast-Track Processing", desc: "Critical Skills Permit in 2-3 weeks" },
                { icon: Users, title: "Family Permit Support", desc: "Bring your family to Ireland" }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
            ...
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Message / Tech Skills</label>
                    <textarea required value={formData.message} onChange={(e) => setFormData({...formData, message: e.target.value})} rows={4} className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-transparent transition" placeholder="Tell us about your tech skills and experience..."></textarea>
                  </div>
              ...
              <div className="order-1 md:order-2">
                <img src={`${import.meta.env.BASE_URL}services/immigration.jpg`} alt="Ireland IT Work Visa" className="w-full h-56 md:h-full rounded-xl object-cover shadow-lg" />
              </div>
            </div>
          </div>
        </div>
