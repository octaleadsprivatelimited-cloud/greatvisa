...
import { Briefcase, CheckCircle, Users, Mail, Phone, MapPin, ArrowRight, MessageCircle, FileText, Globe, Award, TrendingUp, ClipboardCheck, ShieldCheck, Building } from 'lucide-react';
...
const UKTier2VisaConsultantsHyderabad = () => {
  useEffect(() => {
    updatePageSEO(
      ...
      'Leading UK Tier 2 visa consultants in Hyderabad. Expert assistance for UK Tier 2 work visa, skilled worker sponsorship, and UK employment visa applications.',
      [
        'UK tier 2 visa consultants Hyderabad',
        'UK tier 2 work visa Hyderabad',
        'tier 2 visa consultants',
        'UK tier 2 sponsorship',
        'UK tier 2 visa services Hyderabad',
        'tier 2 general visa consultants',
        'UK tier 2 visa processing',
        'UK tier 2 work permit',
        'tier 2 visa application Hyderabad',
        'UK tier 2 immigration',
        'tier 2 skilled worker visa',
        'UK tier 2 visa requirements',
        'best tier 2 visa consultants',
        'UK tier 2 visa Hyderabad',
        'tier 2 visa assistance'
      ]
    );
  }, []);
        ...
        <div className="relative z-10 container mx-auto px-4 w-full">
          <div className="max-w-6xl mx-auto">
            <nav className="text-sm text-white/80 mb-6">
              ...
              <span className="text-white">UK Tier 2 Visa - Hyderabad</span>
            </nav>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center text-white">
              <div>
                ...
                >
                  Expert UK work visa services from Hyderabad.
                </motion.p>
              ...
              <div className="hidden md:block">
                <div className="glass-effect rounded-2xl p-6 shadow-neon-lg">
                  <div className="grid grid-cols-2 gap-4">
                    {[{label: 'Success Rate', value: '93%'}, {label: 'Cases Approved', value: '700+'}, {label: 'Years Experience', value: '10+'}, {label: 'Industries', value: '15+'}].map((s, idx) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Leading UK Tier 2 Visa Consultants in Hyderabad</h2>
              ...
              >
                ...
                <div className="divide-y divide-gray-200">
                  {[
                    { q: 'What is UK Tier 2 visa now called?', a: 'UK Tier 2 visa is now known as the Skilled Worker visa under the new points-based immigration system.' },
                    ...
                    { q: 'Do you provide post-landing support?', a: 'Yes, we offer pre-departure orientation and post-landing support in the UK.' }
                  ].map((item, idx) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-stretch">
              ...
              >
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Book Your Consultation</h2>
              ...
              <div className="order-1 md:order-2">
                <img src={`${import.meta.env.BASE_URL}services/businessvisa.jpg`} alt="UK Tier 2 Visa Hyderabad" className="w-full h-56 md:h-full rounded-xl object-cover shadow-lg" />
              </div>
            </div>
          </div>
        </div>
