          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 text-center">
                Start Your Netherlands Career
              </h2>
              <p className="text-gray-600 text-center mb-8">
                Fill out the form below for a free eligibility assessment
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
                    placeholder="Tell us about your profession, qualifications, and work experience..."
                  ></textarea>
                </div>
