...
const UKVisitorVisaConsultants = () => {
  ...
  const handleWhatsAppClick = () => {
    const message = "Hi, I'm interested in UK Visitor Visa consultancy services. Could you please provide more information?";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          >
            Expert Guidance for Your UK Visit
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                We understand the UK visa requirements and documentation process, guiding you through every step to maximize your chances of approval.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                ...
                { icon: Clock, title: "Fast Processing", desc: "Efficient handling to meet your travel dates" },
                { icon: Users, title: "Personalized Support", desc: "One-on-one consultation for your specific case" },
                { icon: Plane, title: "High Success Rate", desc: "Proven track record of visa approvals" }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
