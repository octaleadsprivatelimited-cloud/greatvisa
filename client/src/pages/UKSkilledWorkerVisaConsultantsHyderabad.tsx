...
import { Briefcase, CheckCircle, Clock, Users, Mail, Phone, MapPin, ArrowRight, MessageCircle, Award } from 'lucide-react';
...
const UKSkilledWorkerVisaConsultantsHyderabad = () => {
  ...
  const handleWhatsAppClick = () => {
    const message = "Hi, I'm from Hyderabad and interested in UK Skilled Worker Visa. Could you please provide more information?";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          >
            Your Trusted Partner for UK Work Visa
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                UK Skilled Worker Visa Consultancy in Hyderabad
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
                    placeholder="Tell us about your profession, skills, and work experience..."
                  ></textarea>
                </div>
